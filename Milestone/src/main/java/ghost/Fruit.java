...
public class Fruit extends GameObject {
    ...
    /**
     * Check if a player is in the same grid as a fruit. If so, set the alive status to false.
     */
    public void tick() {
    ...
    /** 
    * Count fruit left on the map. If there is one or more left, return true, else return false.
    ...
    */
     ...
     * @param b If b is true then the fruit is alive, if b is false the fruit is dead.
     */
